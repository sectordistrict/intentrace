    ...
    let array: Vec<(Sysno, SysAnnotations)> = vec![
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "positive number of bytes read, 0 means end of file, -1 means error, and \
                     errno modified",
                ],
            ),
        ),
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "positive number of bytes written, 0 means end of file,  -1 means error, and \
                     errno modified",
                ],
            ),
        ),
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "zero means done eof (done reading), on success returns number of bytes read, \
                     -1 On error and errno is modified",
                ],
            ),
        ),
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "zero means nothing was written (done writing), on success returns number of \
                     bytes written, -1 On error and errno is modified",
                ],
            ),
        ),
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "iovec",
                        "array of iovec structs containing pointer-length pairs of scattered \
                         regions to be written",
                    ],
                    ["count", "number of iovec structs in the iovec array"],
                ],
                [
                    "return value",
                    "on success returns number of bytes read, -1 On error and errno is modified",
                ],
            ),
        ),
        (
            ...
            (
                ...
                [
                    "return value",
                    "on success returns number of bytes written, -1 On error and errno is modified",
                ],
            ),
        ),
        (
            ...
            Sysno::preadv,
            (
                "scatter read, read vectored, read from several non contiguous regions using your \
                 own offset to avoid file pointer data race",
                &[
                    ["fd", "file descriptor of the file to be read from"],
                    [
                        "iovec",
        ...
        (
            ...
            Sysno::pwritev,
            (
                "gather write, write vectored from several non contiguous regions using your own \
                 offset to avoid file pointer data race",
                &[
                    ["fd", "file descriptor of the file to be written into"],
                    [
                        "iovec",
        ...
        (
            ...
            (
                "scatter read, read vectored, read from several non contiguous regions using your \
                 own offset to avoid file pointer data race in addition to customized flags",
                &[
                    ["fd", "file descriptor of the file to be read from"],
                    [
                        "iovec",
        ...
        (
            ...
            (
                "gather write, write vectored from several non contiguous regions using your own \
                 offset to avoid file pointer data race in addition to customized flags",
                &[
                    ["fd", "file descriptor of the file to be written into"],
                    [
                        "iovec",
        ...
        (
            Sysno::pipe2,
            (
                "create a unidirectional pipe for process communication, in additiona to flags \
                 for file opening behaviour",
                &[
                    ["pipefd", "pointer to array containing the read and write file descriptors"],
        ...
        (
            ...
            (
                ...
                &[["oldfd", "file descriptor to be copied"], ["newfd,", "new file descriptor"]],
                ["return value", "-1 on error, errno modified"],
            ),
        ),
        ...
        (
            ...
            (
                ...
                [
                    "numeric return",
                    "0 on success (all permissions were granted), -1 on error (at least one \
                     permission was not granted), errno modified",
                ],
            ),
        ),
        (
            Sysno::faccessat,
            (
                "check permissions on a file, with an optional anchor directory, and path \
                 resolution flags",
                &[
        ...
        (
            Sysno::openat2,
            (
                "open and possibly create a file, use dirfd as anchor, and open_how for further \
                 customization",
                &[
                    ["dirfd", "file descriptor of the anchor directory"],
                    ["pathname", "path of the file to be opened"],
        ...
        (
            ...
            (
                ...
                &[
                    [
                        "buf",
                        "buffer to fill with the absolute path of the current working directory",
                    ],
                    ["size", "size of the absolute path buffer"],
                ],
                [
                    "return value",
                    "pointer to path of the current working directory, null on error, and errno \
                     modified",
                ],
            ),
        ),
        ...
        (
            ...
            (
                ...
                &[["oldpath", "old path of the file"], ["newpath", "new path of the file"]],
                ["return value", "0 success. -1 for error and errno modified"],
            ),
        ),
        (
            ...
            (
                ...
                &[
                    [
                        "olddirfd",
                        "file descriptor of a path to use as anchor if oldpath is relative",
                    ],
                    ["oldpath", "old path of the file"],
                    [
                        "newdirfd",
                        "file descriptor of a path to use as anchor if newpath is relative",
                    ],
        ...
        (
            Sysno::renameat2,
            (
                "rename a file and possibly move it, with an optional anchor directory and flags \
        ...
        (
            ...
            (
                ...
                //
                // The link() system call can be used to detect and trace malicious or suspicious
                // file modification. For example, if a malicious user is trying to
                // modify or delete files in a system, creating/deleting a hard
                // link to the file is one way to do this. Tracking the link()
                // system call will notify if any files are modified in this way.
        ...
        (
            Sysno::linkat,
            (
                "create a hard link for a file, with an optional anchor directory, and path \
                 resolution flags",
                &[
                    [
                        "olddirfd",
        ...
        (
            ...
            (
                ...
                // anywhere else).
                "either deletes a file or directory, or in the case that other references still \
                 exist, simply reduces the reference count of the inode",
        ...
        (
            ...
            (
                "either deletes a file or directory, or in the case that other references still \
                 exist, simply reduces the reference count of the inode, in addtion to an \
                 optional anchor directory, and a behaviour customization flag",
                &[
                    ["dirfd", "file descriptor of a path to use as anchor if pathname is relative"],
                    ["pathname", "path of the file or directory to be removed"],
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "the number of bytes read to the buffer (can truncate if filled), -1 is \
                     returned On error and errno is modified",
                ],
            ),
        ),
        (
        ...
        (
            Sysno::chmod,
            (
                "change the mode (rwx rwx rwx, set-uid, set-guid, sticky bits) of the file given \
                 through a file path",
                &[
        ...
        (
            ...
            (
                "change the mode (rwx rwx rwx, set-uid, set-guid, sticky bits) of the file given \
                 through a file path, in addition to path traversal flags",
                &[
                    ["dirfd", "file descriptor of a path to use as anchor if pathname is relative"],
                    ["pathname", "path of the file to be altered"],
                    ["mode", "directory permissions (rwx rwx rwx, set-uid, set-guid, sticky bits)"],
        ...
        (
            Sysno::lchown,
            (
                "change the owner and group of a given file by its path without recursing \
                 symbolic links",
                &[
                    ["pathname", "path of the file to be altered"],
                    ["owner", "new owner to be set for the file"],
        ...
        (
            Sysno::fchownat,
            (
                "change the owner and group of a given file by its path, with an optional anchor \
                 directory, in addition to path traversal flags",
                &[
                    ["dirfd", "file descriptor of a path to use as anchor if pathname is relative"],
                    ["pathname", "path of the file to be altered"],
                    ["owner", "new owner to be set for the file"],
        ...
        (
            ...
            Sysno::syncfs,
            (
                "flush all current pending filesystem data and metadata writes via a file \
                 descriptor within that filesystem",
        ...
        (
            ...
            Sysno::fdatasync,
            (
                "flush all current pending data writes and ignore non-critical metadata writes \
                 for a specific file",
                &[["fd", "file descriptor of the file whose pending writes are to be flushed"]],
                ["return value", "0 success. -1 for error and errno modified"],
            ),
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "statbuf",
                        "pointer to a buffer which will contain the information about the file \
                         upon success",
                    ],
                ],
                ["return value", "0 success. -1 for error and errno modified"],
        ...
        (
            Sysno::newfstatat,
            (
                "find information about a file using its path, while specifying an anchor, and \
                 path resolution flags",
                &[
                    [
                        "dirfd",
                        "file descriptor used either as anchor for pathname, or as a target file",
                    ],
                    ["pathname", "path of the file"],
                    [
                        "statbuf",
                        "pointer to a struct where the retrieved information will be stored",
                    ],
        ...
        (
            Sysno::statx,
            (
                "find information about a file using its path, while specifying an anchor, path \
                 resolution flags, and specific fields to retrieve",
                &[
                    ["dirfd", "file descriptor of a path to use as anchor if pathname is relative"],
                    ["pathname", "path of the file"],
                    ["flags", "path resolution behaviour"],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "cachestat_range",
                        "pointer to a struct identifying the offset and range of bytes to find \
                         information about, pages ceil",
                    ],
                    [
                        "cachestat",
                        "pointer to a struct where the page caches information will be stored",
                    ],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "whence",
                        "determine usage of the offset (offset as new position vs offset as \
                         addititon to current position vs ... etc)",
                    ],
                ],
                [
                    "return value",
                    "on success returns resulting offset location as measured in bytes from the \
                     beginning of the file. (off_t) -1 is returned On error and errno is modified",
                ],
            ),
        ),
        (
            ...
            (
                ...
                [
                    "return value",
                    "on success: pointer to the mapped area.  On error, the value MAP_FAILED \
                     (that is, (void *) -1) is returned, and errno is modified",
                ],
            ),
        ),
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "new program break pointer on success, -1 on error and errno ENOMEM only",
                ],
            ),
        ),
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "len",
                        "amount of bytes of memory to lock beginning from the addr, pages ceil",
                    ],
                ],
        ...
        (
            Sysno::mlock2,
            (
                "lock a range of memory in RAM to prevent swapping, in addition to a flag that \
                 specifies how to handle non-resident pages",
                &[
                    ["addr", "starting address of the memory to be locked"],
                    // Pages Ceil
                    [
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "len",
                        "amount of bytes of memory to unlock beginning from the addr, pages ceil",
                    ],
                ],
                ["return value", "0 success. -1 for error and errno modified and no changes made"],
            ),
        ...
        (
            ...
            Sysno::mlockall,
            (
                "lock the entire memory of a process to prevent swapping, in addition to flags \
                 for handling non-resident and future pages",
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "old_address",
                        "old address of the memory region to be shrinked, expanded, or moved",
                    ],
                ...
                [
                    "return value",
                    "on success: pointer to the mapped area. On error, the value MAP_FAILED (that \
                     is, (void *) -1) is returned, and errno is modified",
                ],
            ),
        ),
        ...
        (
            ...
            Sysno::mincore,
            (
                "indicate in a vector which parts of a memory range are resident and which will \
                 cause a page fault if accessed",
                &[
                    ["addr", "address in the file mapping where calculation starts"],
                    [
                        "length",
                        "amount of bytes from beginning address where the calculation of resident \
                         pages will consider",
                    ],
                    [
                        "vec",
                        "pointer to array of bytes each represents a memory page, every byte \
                         indicates if the respective page is resident",
                    ],
                ],
                ["numeric return", "0 on success, -1 on error, errno modified"],
            ),
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "length",
                        "amount of bytes from beginning address indicating the range where the \
                         advice should be taken in consideration",
                    ],
        ...
        (
            Sysno::select,
            (
                "block while watching file descriptor sets for readiness to read, write, in \
                 addition to exceptional conditions",
                &[
                    [
                        "nfds",
                        "the number of the highest file descriptor in the three sets + 1, used by \
                         the kernel to loop each set",
                    ],
                    // you can set any of these sets to NULL if you don’t care about waiting for it
                    [
                        "readfds",
                        "pointer to struct containing an array of file descriptors watched to see \
                         if they are ready for reading",
                    ],
                    [
                        "writefds,",
                        "pointer to struct containing an array of file descriptors watched to see \
                    ...
                    [
                        "exceptfds,",
                        "pointer to struct containing an array of file descriptors in this set \
                         are watched for \"exceptional conditions\"",
                    ],
                    ...
                    [
                        "timeout",
                        "pointer to struct describing the amount of time select will block in \
                         microseconds",
                    ],
                ],
                [
                    "retrun value",
                    "total number of file descriptors in all sets, 0 if timeout expired before \
                     any file descriptors became ready, On error -1, and errno modified, file \
                     descriptor sets are left unmodified, and timeout becomes undefined",
                ],
            ),
        ),
        (
            ...
            (
                "block while watching file descriptor sets for readiness to read, write, in \
                 addition to exceptional conditions, and watch for new signals",
                &[
                    [
                        "nfds",
                        "the number of the highest file descriptor in the three sets + 1, used by \
                    ...
                    [
                        "sig",
                        "pointer to struct containing both the signal mask to watch for and its \
                         size",
                    ],
                ],
                [
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "number of elements in nfds for which events have occurred, -1 on error, \
                     errno modified",
                ],
            ),
        ),
        (
            Sysno::ppoll,
            (
                "block until specific events occur on the provided file descriptors or until some \
                 signals are caught",
                &[
                    ["fds", "array of file descriptor-event pairs for poll to monitor"],
                    ["nfds", "number of elements in pollfd"],
                    [
                        "tmo_p",
                        "pointer to struct containing amount of time to block in nanoseconds",
                    ],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "size",
                        "number of fds expected to be added later, this argument is no longer \
                         needed, but must not be 0",
                    ],
                ],
                ["return value", "-1 on error, errno modified"],
            ),
        ...
        (
            ...
            Sysno::epoll_create1,
            (
                "creates a new epoll instance and return a file descriptor for it, in addition to \
                 customizing behaviour with a flag",
                &[
        ...
        (
            ...
            Sysno::epoll_wait,
            (
                "block and wait for events on an epoll instance, equivalent to fetching from the \
                 ready list",
                &[
                    ["epfd", "file descriptor of the epoll instance to be waited on"],
                    [
                        "epoll_event",
                        "buffer where information about ready file descriptors will be stored",
                    ],
                    [
                        "maxevents",
                        "maximum number of events to be returned from the epoll instance",
                    ],
        ...
        (
            ...
            Sysno::epoll_pwait,
            (
                "block and wait until either an event on the epoll instance or a signal, \
                 equivalent to fetching from the ready list or waiting for a signal",
                &[
                    ["epfd", "file descriptor of the epoll instance to be waited on"],
                    [
                        "events",
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "event",
                        "struct containing information about the event associated with the \
                         operation",
                    ],
                ],
                ["return value", "0 success. -1 for error and errno modified"],
        ...
        (
            ...
            (
                ...
                &[
                    [
                        "family",
                        "communication domain (Internet/IPV4, IPV6, Bluetooth, Amateur radio, XDP \
                         ..etc)",
                    ],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "addrlen",
                        "pointer to integer specifying the length in bytes of the address buffer",
                    ],
                ],
                ["return value", "0 success. -1 for error and errno modified"],
            ),
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "optlen",
                        "pointer to integer specifying the size in bytes of the option value \
                         buffer",
                    ],
                ],
                ["return value", "0 success. -1 for error and errno modified"],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "optlen",
                        "pointer to integer specifying the length in bytes of the option value \
                         buffer",
                    ],
                ],
                ["return value", "0 success. -1 for error and errno modified"],
        ...
        (
            Sysno::listen,
            (
                "create a backlog queue, and mark the socket descriptor as passive (ready to \
                 accept connections)",
                &[
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "file descriptor of the new connection that was extracted, -1 for error and \
                     errno modified",
                ],
            ),
        ),
        (
            ...
            Sysno::accept4,
            (
                "extract the first connection from the connection queue in addition to specifying \
                 behaviour flag such as non-block and close-on-exec",
                &[
                    ["sockfd", "file descriptor of the socket listening for connections"],
                    // nullable, and when nullable it is not filled
                    ["addr", "buffer where information about the peer connection will be stored"],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "buf",
                        "pointer to a buffer containing the message to be sent and the length of \
                         the message",
                    ],
                ...
                [
                    "return value",
                    "number of bytes written, 0 means end of file, -1 means error, and errno \
                     modified",
                ],
            ),
        ),
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "msg",
                        "pointer to struct containing the target socket address, the size of the \
                         struct, and an array containing the message to be sent",
                    ],
                    ["flags", "flags to customize syscall behaviour"],
                ],
                [
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "src_addr",
                        "buffer which will contain the source address of the socket we received \
                         the data from",
                    ],
                    // value-result argument, will become the length of the buffer, and truncation
                    // rules apply
                    ["addrlen", "size of the source address buffer"],
                ],
                [
                    "return value",
                    "number of bytes written, 0 means zero-length datagrams which are permitted, \
                     -1 means error, and errno modified",
                ],
            ),
        ),
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "msg",
                        "pointer to a struct containing the details of data received including \
                         scatter-gather buffer and length information",
                    ],
                    ["flags", "?"],
                ],
                [
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "0 on success (sometimes this is a output value), -1 on error, errno modified",
                ],
            ),
        ),
        (
            ...
            (
                ...
                &[
                    ...
                    // pointer to userspace  or it could be an index, a flag, whatever
                    // It might even be unused and conventionally passed in a 0
                    [
                        "argp",
                        "typeless extra argument, the driver defineds it, and can vary based on \
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "addr",
                        "can be either an unsigned long for set operations, or a pointer to \
                         unsigned long for get operations",
                    ],
                ],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "sigsetsize",
                        "size of the signal sets in the action mask and the old action mask",
                    ],
                ],
                ["numeric return", "0 on success, -1 on error, errno modified"],
            ),
        ...
        (
            ...
            (
                "modify or get the signal mask (signals blocked from delivery) of the calling \
                 thread",
                &[
        ...
        (
            ...
            Sysno::rt_sigsuspend,
            (
                "temporarily alter the signal mask of the and suspend execution until the \
                 delivery of a signal that has a handler or one that terminates the thread",
                &[
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "ss",
                        "pointer to a struct containing information about the new signal stack to \
                         use",
                    ],
                    // NULLABLE meaning we dont want it
                    [
                        "old_ss",
                        "pointer to an empty signal stack struct to store the old signal stack \
                         information",
                    ],
                ],
                ["numeric return", "0 on success, -1 on error, errno modified"],
        ...
        (
            ...
            (
                "suspends execution of the process until one of the signals provided is pending, \
                ...
                &[
                    ...
                    [
                        "info",
                        "pointer to struct where information about the signals found will be \
                         stored",
                    ],
                    [
                        "timeout",
        ...
        // needs access to the PID of another process in order to send retrieve information
        // about the or similar operations. It can also be used to monitor the lifetime of
        // the since the file descriptor is closed when the process terminates.
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "flags",
                        "flag for customization, currently does not provide any functionality",
                    ],
                ],
                ["numeric return", "0 on success, -1 on error, errno modified"],
            ),
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "flags",
                        "flags to select the random source, and whether the call should block",
                    ],
                ],
                [
                    "return value",
                    "number of random bytes retrieved, -1 On error and errno is modified",
                ],
            ),
        ),
        (
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "rlim",
                        "pointer to a struct where the soft and hard limits of the resource will \
                         get stored",
                    ],
                ],
                ["numeric return", "0 on success, -1 on error, errno modified"],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "new_limit",
                        "pointer to a struct containing the soft and hard limits to use as new \
                         limits",
                    ],
                    // NULLABLE
                    [
        ...
        (
            ...
            (
                ...
                &[[
                    "buf",
                    "pointer to a struct where various timing metrics for the process will get \
                     stored",
                ]],
                [
                    "numeric return",
                    "number of clock ticks for the process since an arbitrary point, -1 on error, \
                     errno modified",
                ],
            ),
        ),
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "mask",
                        "pointer to struct where the current thread's CPU bitmask will be stored",
                    ],
                ],
                ["numeric return", "0 on success, -1 on error, errno modified"],
            ),
        ...
        (
            ...
            Sysno::exit,
            ("exit the calling process", &[["status", "status of the process on exit"]], ["", ""]),
        ),
        (
            Sysno::exit_group,
            (
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "rseq",
                        "pointer to the thread-local rseq struct to be shared between kernel and \
                         user-space",
                    ],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "timeout",
                        "either a pointer to a timeout struct for blocking operations or a normal \
                         numeric value specific to some operations",
                    ],
        ...
        (
            ...
            // thread ID at this address. When a thread whose clear_child_tid is not
            // NULL terminates, then, if the thread is sharing memory with other
            // threads, then 0 is written at the address specified in clear_child_tid
            // and the kernel performs the following operation: futex(clear_child_tid,
            // FUTEX_WAKE, 1, NULL, NULL, 0); The effect of this operation is to wake a
            // single thread that is performing a futex wait on the memory location.
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "rusage",
                        "pointer usage to a struct where the the resource usage metrics will get \
                         stored",
                    ],
                ],
                [
                    "numeric return",
                    "pid of the child whose state has changed, or 0 on no state change for \
                     WNOHANG, -1 on error, errno modified",
                ],
            ),
        ),
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "infop",
                        "pointer to a struct that will store the information about the child",
                    ],
                    ["options", "specific state changes to wait for"],
                    // NULLABLE means do not want
        ...
        (
            ...
            // not affect the other. The child process is an exact duplicate of the
            // parent process except for the following points: •  The child has its own
            // unique process ID,
            ...
            // a signal when its parent terminates. •  The default timer slack value is
            // set to the parent's current timer slack value. •  madvise(2)
            // MADV_DONTFORK marked Memory mappings flag are not inherited
            ...
            (
                ...
                [
                    "return value",
                    "0 returned to the child and the new process id of the child returned to the \
                     calling -1 on error, errno modified",
                ],
            ),
        ),
        (
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "argv",
                        "array of pointers to strings containing the command-line arguments for \
                         the program",
                    ],
                    // terminated by a null pointer
                    [
                        "envp",
                        "array of pointers to `key=value` strings containing the environment of \
                         the new program",
                    ],
                ],
        ...
        (
            Sysno::nanosleep,
            (
                "suspend execution of the calling thread until the specified timeout, or \
                 ocurrence of siganl handling",
                &[
                    ...
                    [
                        "rem",
                        "pointer to a struct where the remaining time is to be stored in case of \
                         an interruption",
                    ],
                ],
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "attr",
                        "pointer to struct containing a bitmask of actions to be handled by this \
                         ruleset",
                    ],
                ...
                [
                    "return value",
                    "landlock ruleset file descriptor, or a Landlock ABI version, -1 for error, \
                     and errno modified",
                ],
            ),
        ),
        (
            ...
            (
                ...
                &[
                    [
                        "ruleset_fd",
                        "file descriptor of the landlock ruleset where the rule will be added",
                    ],
        ...
        (
            ...
            (
                ...
                [
                    "return value",
                    "priority of the process/process group/user. -1 for error and errno modified",
                ],
            ),
        ),
        (
        ...
        (
            ...
            (
                ...
                &[
                    ...
                    [
                        "dirp",
                        "pointer to a buffer where the retrieved directory entries will be stored",
                    ],
                ...
                [
                    "return value",
                    "number of bytes read on success. -1 for error and errno modified",
                ],
            ),
        ),
        (
